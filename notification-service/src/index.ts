...
export const logFeed: Array<{ message: string; timestamp: string; orderId: string; eventType: string }> = [];
...
async function start() {
    await startConsumer();
    server.listen(PORT, () => {
        console.log(`[Notification Service] Running on port ${PORT} | Socket.io ACTIVE`);
    });
}
